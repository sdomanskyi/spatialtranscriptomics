...
![__Figure__: BayesSpace clusters density of spots on a 2D UMAP layout.](`r paste0(samplePath, "umap_density_clusters_/UMAP_clusters_embedding_density.png")`){width=`r mv`px}
